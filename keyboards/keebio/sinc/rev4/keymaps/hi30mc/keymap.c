...
bool rgb_matrix_indicators_advanced_user(uint8_t led_min, uint8_t led_max) {
    ...
    switch (curr_flag) {
        case TRANS:
            ...
            flag[3]    = (HSV){197 * 255 / 360, 63 * 255 / 100, 98 * 255 / 100};
            num_colors = 4;
            break;
        case LESBIAN:
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_80_with_macro(
    ...
    XXXXXXX, KC_F16 , KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,      KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_DEL,  KC_BSPC, KC_HOME,
    ...
    XXXXXXX, KC_CYLR, KC_LCTL, KC_LALT, KC_LGUI, MO(2),   MO(1),   KC_BSPC,                     TG(1),   KC_SPC,  KC_RALT, KC_RCTL, KC_RGUI, KC_LEFT, KC_DOWN, KC_RGHT
  ),
  [1] = LAYOUT_80_with_macro(
    ...
    _______, _______, _______, _______, KC_KP_0, KC_PDOT, MO(1),   KC_PENT,                     TG(1),   TG(2)  , _______, _______, _______, _______, _______, _______
  ),
  [2] = LAYOUT_80_with_macro(
   ...
   _______, _______, _______, _______, _______, _______, _______, _______,            _______, _______, _______, _______, _______, _______,          _______, _______,
   _______, _______, _______,          _______, _______, _______, _______, _______,            _______, _______, _______, _______, _______, _______, _______, _______,
   QK_BOOT, _______, _______, _______, _______, MO(2),   _______, _______,                     KC_LRST, TG(2),   _______, _______, _______, _______, _______, _______
  ),
